# usage: python classify_image.py --image images/boat.png
...
# construct the argument parser nd parse the arguments
...
# load the network weights from disk, flash it to the current
...
# load the preprocessed ImageNet labels
